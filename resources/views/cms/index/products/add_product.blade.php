        ...
        <div class="col-8">
            <form action="{{url('cms/products')}}" method="POST" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <select name="category_id" id="category-id" class="form-control">
                            ...
                            @foreach ($categories as $item )
                                <option @if(old('category_id')==$item['id']) selected="selected" @endif value="{{$item['id']}}">{{$item['category_title']}}</option>   
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                        ...
                        <input value="{{old('product_title')}}" type="text" name="product_title" id="product_title" class="form-control field-input-cms original-text">
                ...
                <div class="form-group">
                        ...
                        <textarea name="article" id="content_article" class="form-control">{{old('article')}}</textarea>
